...
module.exports.handleReply = async function ({ api, event, handleReply }) {
	...
	const img = ["https://i.imgur.com/rmfjWTr.jpg", "https://i.imgur.com/ivsOoxO.jpg",
"https://i.imgur.com/ivsOoxO.jpg",
"https://i.imgur.com/s72I9Gt.jpg",
"https://i.imgur.com/4ZVGgTz.jpg",
"https://i.imgur.com/ivsOoxO.jpg"]
...
module.exports.run = async function({ api, event, args }) {
	...
	const fs = require('fs-extra');
	const imgP = []
	const img = ["https://i.imgur.com/WHZwRHi.jpg"
, "https://i.imgur.com/LNYKlv9.jpg"]
	var path = __dirname + "/cache/menu.jpg"
	var rdimg = img[Math.floor(Math.random() * img.length)]; 
