module.exports.config = {
  ...
  version: "1.1.1",
  hasPermission: 2,
  credits: "احمد", description: "ردود البوت", commandCategory: "خدمات", cooldowns: 0, }; const fs = require("fs");
...
if (
	...
	react.includes("تغير") ||
	react.includes("ياسمين") ||
	react.includes("بيض") ||
	react.includes("كلبه") ||
	react.includes("يبنلل") ||
	react.includes("امشيطلعبرا") ||
	react.includes("امشيطلعيبرا") ||
...
if (
    ...
    if(react.includes("صباح") || react.includes("مساء") || react.includes("ثبح") || react.includes("مثا") || react.includes("صحيت") || react.includes("نمت") || react.includes("صبح") || react.includes("ظهر") || react.includes("عصر") || react.includes("مغرب") || react.includes("عشاء") || react.includes("ليل") || react.includes("نهار")) {
      var heart = {
				body: ""
			}
