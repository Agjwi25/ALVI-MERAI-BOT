...
module.exports.run = async function({ api, event, Users, Currencies }) {
        ...
        if( money < 10) api.sendMessage(`انت لا تملك المال الكافي لهذا\n\n قم بكتابة هذا الامر لتحصل على بعض المال ${global.config.PREFIX}كهف\n\nصنع بواسطة: احمد`, event.threadID, event.messageID) //thay số tiền cần trừ vào 0, xóa money = 0
        else {
